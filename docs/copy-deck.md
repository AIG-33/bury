...
Tone: warm, sporty, community-first, with light tennis humor. The platform speaks to **every amateur player in Belarus**, not to one specific club or coach. Light references to ATP-tour pop culture (Federer's one-handed backhand, "ace" / "net cord" as everyday slang) are OK; references to specific players or biographies are not — keep the copy inclusive.

## Brand line

| Locale | Hero line                                                        |
| ------ | ---------------------------------------------------------------- |
| ru     | Твой теннисный рейтинг. Без компромиссов. Один Эло на все матчи. |
| en     | Your tennis ranking. No compromises. One Elo across every match. |
| pl     | Twój ranking tenisowy. Bez kompromisów. Jedno Elo na każdy mecz. |
...
| `toast.elo_up`   | +{n} Elo. Sędzia kiwa głową z aprobatą.    | +{n} Elo. Clean hit, count it.           | +{n} к Elo. Чистый удар — засчитан. |
