...
**Целевая аудитория** — любители тенниса в Беларуси: игроки любого уровня (от новичков, прошедших свой первый турнир, до полупрофи), тренеры и небольшие клубы. Сценарий «сегодня вечером найти соперника своего уровня и сыграть товарищеский матч» — такой же первого ранга, как «зарегистрироваться в турнире».

**Vision проекта.** Это **не приложение одного клуба**, а платформа любительского тенниса со следующими ценностями:

- **Единый Elo-рейтинг**, который путешествует с игроком между турнирами / тренерами / товарищескими матчами и принимает импортированный рейтинг с [ligatennisa.com](https://www.ligatennisa.com).
...
**Конкурентная среда.** В Беларуси теннисное сообщество в основном координируется в WhatsApp/Telegram-чатах и через сайты отдельных клубов; единой платформы с открытым рейтингом, сеткой турниров и поиском соперника нет. Ближе всего по охвату — `ligatennisa.com` (любительская лига Беларуси с собственной системой Эло), но это закрытая лига внутри своих турниров, без модели «найти соперника прямо сейчас» и без публичного API. Наш фокус: **сообщество, рейтинг, матчи**. Бронирование собственных слотов тренера — частный случай для клиентов конкретного тренера, не основной продукт.

**Происхождение проекта.** Платформа была запущена в 2026 году по инициативе **Александра Бурого** — бывшего профессионала ATP (пара №59 в 2015 году, чемпион Swiss Open Gstaad 2015 в паре с Денисом Истоминым), сейчас тренера в Минске. На самой платформе он представлен как обычный тренер со своим профилем; продукт спроектирован так, чтобы любой клуб или тренер в Беларуси мог им пользоваться без привязки к конкретной площадке или человеку.
...
- Языки — RU (default) / EN. PL удалён в миграции `20260510000000_belarus_relocation.sql`.
- TZ — `Europe/Minsk`.
- Валюта — BYN (белорусский рубль). Колонки `coach_hourly_rate_byn`, `entry_fee_byn`, `price_byn`.
- Гео — Беларусь: `country = 'BY'`, ~30 кортов в 11 городах (Минск + 5 областных + 6 районных). См. seed-миграцию.
