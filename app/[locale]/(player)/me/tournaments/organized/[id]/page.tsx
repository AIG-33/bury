...
export default async function OrganizedTournamentDetailPage({ params }: Props) {
  ...
  const bracketCopy: BracketCopy = {
    ...
    change_score: t("bracket.change_score"),
    reset_score: t("bracket.reset_score"),
    reset_confirm: t("bracket.reset_confirm"),
    resetting: t("bracket.resetting"),
    exact_score: t("bracket.exact_score"),
    save: t("bracket.save"),
  ...
  const groupsCopy: GroupsCopy = {
    ...
    extra_qualifiers_label: t("groups.extra_qualifiers_label"),
    extra_qualifiers_help: t("groups.extra_qualifiers_help"),
    ...
    qualifiers_summary_extra: t("groups.qualifiers_summary_extra", {
      groups: "{groups}",
      n: "{n}",
      k: "{k}",
      size: "{size}",
